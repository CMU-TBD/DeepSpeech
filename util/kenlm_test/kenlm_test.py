...
# From https://github.com/kpu/kenlm/blob/master/python/example.py with slight modifications
# Used to test the kenlm language model

import os
import kenlm

LM = os.path.join(os.path.dirname(__file__), '..', '..', 'data', 'lm', 'lm_filtered.arpa')
...
while (True):
    sentence = input("Enter the phrase or enter exit() to exit >> ")
